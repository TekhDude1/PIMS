! function (a) {
    ...
    function t(e) {
        1 == a("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (a("#dark-mode-switch").prop("checked", !1), a("#rtl-mode-switch").prop("checked", !1), a("#bootstrap-style").attr("href", "static/dashboard/css/bootstrap.min.css"), a("#app-style").attr("href", "static/dashboard/css/app.min.css"), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == a("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (a("#light-mode-switch").prop("checked", !1), a("#rtl-mode-switch").prop("checked", !1), a("#bootstrap-style").attr("href", "static/dashboard/css/bootstrap-dark.min.css"), a("#app-style").attr("href", "static/dashboard/css/app-dark.min.css"), sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == a("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e && (a("#light-mode-switch").prop("checked", !1), a("#dark-mode-switch").prop("checked", !1), a("#bootstrap-style").attr("href", "static/dashboard/css/bootstrap.min.css"), a("#app-style").attr("href", "static/dashboard/css/app-rtl.min.css"), sessionStorage.setItem("is_visited", "rtl-mode-switch"))
    }
